...
#ifdef MPI_SUPPORT
	enum EngineType {EngineType_Basic, EngineType_SSE, EngineType_SSE_Compressed, EngineType_Multithreaded, EngineType_MPI, EngineType_Hwy, EngineType_Hwy_Wide, EngineType_Hwy_Tiled};
#else
	enum EngineType {EngineType_Basic, EngineType_SSE, EngineType_SSE_Compressed, EngineType_Multithreaded, EngineType_Hwy, EngineType_Hwy_Wide, EngineType_Hwy_Tiled};
#endif
	EngineType m_engine;
